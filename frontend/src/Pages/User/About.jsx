...
import NewsletterBox from '../../components/User/Newsletter';
  ...
  <div>
    ...
    <div className='my-10 flex flex-col md:flex-row gap-16'>
       ...
       <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
         <p>"Urbancove" is a popular name associated with several e-commerce websites, but most commonly, it refers to Urbancove 21, an American fast-fashion retailer. Urbancove 21 operates both online and through physical stores worldwide, offering a wide range of fashion items, including clothing, accessories, and beauty products. s to various locations.</p>
