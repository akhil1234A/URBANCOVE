        ...
        <div>
          {wishlistItems.map((item) => {
            ...
            return (
              <div
                key={item._id}
                className={`py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4 ${isInvalid ? "opacity-50" : ""
                  }`}
              >
                ...
                <button
                  className="
    bg-black text-white text-sm px-4 py-1
